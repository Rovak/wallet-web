          ...
          <div className="row mt-2">
            <div className="col-md-12 ">
              <div className="card">
                ...
                <table className="table table-hover bg-white m-0" style={tableStyle}>
                  <tbody>
                    <tr>
                      <th>{tu("height")}:</th>
                      <td>{block.number}</td>
...
export default Radium(connect(mapStateToProps, mapDispatchToProps)(Block));
