...
class Login extends Component {
  ...
  isLoginValid = () => {
    let {loginPassword, captchaVal} = this.state;
  ...
  renderLogin() {
    ...
    return (
      <div className="card-text text-center">
        ...
        <div className="text-center pb-3 mx-auto" style={{width: "304px"}}>
            <ReCAPTCHA
                ref="recaptcha"
                sitekey="6LcQw0sUAAAAAIlae8RYPPLpDA5tl18t1YWYoig9"
                onChange={(ev) => this.setState({ captchaVal: 1 })}
              />
        </div>
        <p>
          <button
